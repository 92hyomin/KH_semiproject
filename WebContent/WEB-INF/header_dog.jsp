...
<div id="header">
	<div id="header1" >
        ...
        <div class="col-xs-9 col-md-8">
        	<img width="280" height="80" src="/Semi_Team1/images/mainLogo.png" style="margin-top:20px;cursor:pointer;" onclick="javascript:location.href='<%= request.getContextPath()%>/main.dog';">
  			<ul id ="loginBar">
        ...
        <div class="col-xs-9 col-md-8" id="navbar">
        	<div  id="navbarMenu">
            	<ul id="navbarUl">
                    ...
                    <li style="width:10%;font-weight:bold;font-size:13pt;"><a>구매하기</a></li>
                    <li style="width:10%;font-weight:bold;font-size:13pt;"><a>매거진</a></li>
                    <li style="width:10%;font-weight:bold;font-size:13pt;"><a>우리 이야기</a></li>
